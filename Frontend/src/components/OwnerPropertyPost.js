            ...
            <div>
                ...
                <div class="login-form">
                    ...
                    <br></br>
                            ...
                            <h2><small>Booking Options</small></h2>  
                            <hr width="98%"></hr> 
                            <ul>
                                <li>
                                <label>
                                    ...
                                    type="radio"
                                    value="small"
                                    checked={this.state.size === "instant"}
                                    onChange={this.handleChange}
                                    />
                                    Instant Booking
                                    <h2><small>Automatically accept booking requests from all travelers for dates you have available, and add the bookings to your calendar.
                                    <a class="bg-default" href="#">Learn more</a></small></h2>  
                                </label>
                                </li>
                                ...
                                <label>
                                    ...
                                    />
                                    24-hr review
                                    <h2><small>Allow 24 hours to communicate with guests and accept booking requests.</small></h2>
                                </label>
                                </li>        
                            </ul>
                            <div class="form-group">
